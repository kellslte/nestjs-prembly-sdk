...
export class VietnamDataVerificationService extends BaseGeneratedService {
  ...
  getCompanyNumberVietnam(data: Record<string, any>) {
    return this.execute('getCompanyNumberVietnam', data);
  }
