...
export class TaiwanDataVerificationService extends BaseGeneratedService {
  ...
  getCompanyNumberTaiwan(data: Record<string, any>) {
    return this.execute('getCompanyNumberTaiwan', data);
  }
