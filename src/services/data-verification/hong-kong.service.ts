...
export class HongKongDataVerificationService extends BaseGeneratedService {
  ...
  getCompanyNumberHongKong(data: Record<string, any>) {
    return this.execute('getCompanyNumberHongKong', data);
  }
