...
export class JapanDataVerificationService extends BaseGeneratedService {
  ...
  getCompanyNumberJapan(data: Record<string, any>) {
    return this.execute('getCompanyNumberJapan', data);
  }
