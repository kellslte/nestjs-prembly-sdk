...
export class ThailandDataVerificationService extends BaseGeneratedService {
  ...
  getCompanyNumberThailand(data: Record<string, any>) {
    return this.execute('getCompanyNumberThailand', data);
  }
